...
namespace _2022_2C_I_AgendaTurnos.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdUsuario,mail,FechaAlta,Password,Nombre")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuario,mail,FechaAlta,Password,Nombre")] Usuario usuario)
        {
